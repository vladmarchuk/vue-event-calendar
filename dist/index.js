...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    prettyMonthYear: function prettyMonthYear() {
      var date = this.curYearMonth.split('/');
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.prettyMonthYear))]), _vm._v(" "), _c('div', {
    staticClass: "cal-navigation"
  }, [_c('div', {
    staticClass: "l",
    on: {
      "click": _vm.preMonth
    ...
    }) : _vm._e(), _vm._v(" "), (date.status && date.category === 'local') ? _c('span', {
      staticClass: "date-dot"
    }, [_vm._v(" ")]) : _vm._e(), _vm._v(" "), (date.status && date.category === 'global-colleagues') ? _c('span', {
